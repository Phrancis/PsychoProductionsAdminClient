...
public class FrameDefault extends JFrame {
     ...
     */
    public FrameDefault(int frameWidth, int frameHeight) {
        super();
        setTitle(TITLE);
     ...
     */
    public FrameDefault(int frameWidth, int frameHeight, String frameTitle) {
        super();
        setTitle(frameTitle);
        setSize(frameWidth, frameHeight);
        setDefaultCloseOperation(defaultCloseOperation);
     ...
     */
    public FrameDefault(int frameWidth, int frameHeight, int closeOperation) {
        super();
        setTitle(TITLE);
        setSize(frameWidth, frameHeight);
     ...
     *                       WindowConstants.EXIT_ON_CLOSE
     */
    public FrameDefault(int frameWidth, int frameHeight, String frameTitle, int closeOperation) {
        super();
        setTitle(frameTitle);
        setSize(frameWidth, frameHeight);
        setDefaultCloseOperation(closeOperation);
